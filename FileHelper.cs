...
namespace Core.IO
{
    ...
    public class FileHelper
    {
        ...
        public static void WriteFile(string Path, string Strings)
        {
            ...
            using (StreamWriter f2 = new StreamWriter(Path, true, System.Text.Encoding.UTF8))
        ...
        public static string ReadFile(string Path)
        {
            ...
            {
                using (StreamReader f2 = new StreamReader(Path, System.Text.Encoding.GetEncoding("gb2312"))) { s = f2.ReadToEnd(); }
            }
            return s;
        }
        /// <summary>
        ...
        #endregion 3.2检测指定文件是否存在,如果存在则返回true
        ...
        #endregion 3.4检测指定目录中是否存在指定的文件
        #endregion 3、检测指定文件目录是否存在
        ...
        #endregion 4.2获取指定目录及子目录中所有文件列表
        ...
        #endregion 4.4获取指定目录中所有子目录列表,若要搜索嵌套的子目录列表,请使用重载方法.
        #region 4.5 读取文件列表
        /// <summary>
        /// 4.5读取文件列表
        /// </summary>
        ...
        #endregion 4.5 读取文件列表
        #endregion 4、获取指定目录、文件列表
        #region 5、创建目录及文件
        #region 创建目录
        /// <summary>
        /// 5.1创建目录
        ...
        #endregion 8.6将指定文件夹下面的所有内容copy到目标文件夹下面 果目标文件夹为只读属性就会报错。
        #endregion 8、复制、移动
        #region 9、文件路径
        ...
        #endregion 9.1从文件的绝对路径中获取文件名( 包含扩展名 )
        ...
        #endregion 9.2从文件的绝对路径中获取文件名( 不包含扩展名 )
        ...
        #endregion 10.9获取指定文件详细属性
        #endregion 10、文件类型其他操作
        #region 11、获取文件夹大小
        /// <summary>
        /// 11.1获取文件夹大小
        /// </summary>
