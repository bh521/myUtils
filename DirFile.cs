...
namespace DotNet.Utilities
{
    ...
    public static class DirFile
    {
        ...
        /// <summary>获取指定目录中所有子目录列表,若要搜索嵌套的子目录列表,请使用重载方法.</summary>
        /// <param name="directoryPath">指定目录的绝对路径</param>
        ...
        /// <summary>根据时间得到目录名yyyyMMdd</summary>
        /// <returns></returns>
        public static string GetDateDir()
        {
            return DateTime.Now.ToString("yyyyMMdd");
        }
        /// <summary>根据时间得到文件名HHmmssff</summary>
        /// <returns></returns>
        ...
        /// <summary>检查文件,如果文件不存在则创建</summary>
        ...
        /// <summary>删除指定文件夹对应其他文件夹里的文件</summary>
        ...
        /// <summary>从文件的绝对路径中获取文件名( 包含扩展名 )</summary>
        /// <param name="filePath">文件的绝对路径</param>
        ...
        /// <summary>复制文件参考方法,页面中引用</summary>
        ...
        /// <summary>创建一个文件,并将字节流写入文件。</summary>
        /// <param name="filePath">文件的绝对路径</param>
        ...
        #endregion 获取文本文件的行数
        #region 获取一个文件的长度
        /// <summary>获取一个文件的长度,单位为Byte</summary>
        /// <param name="filePath">文件的绝对路径</param>
        ...
        /// <summary>获取指定目录及子目录中所有子目录列表</summary>
        /// <param name="directoryPath">指定目录的绝对路径</param>
        /// <param name="searchPattern">模式字符串，"*"代表0或N个字符，"?"代表1个字符。 范例："Log*.xml"表示搜索所有以Log开头的Xml文件。</param>
        /// <param name="isSearchChild">是否搜索子目录</param>
        ...
        /// <summary>将源文件的内容复制到目标文件中</summary>
        ...
        /// <summary>从文件的绝对路径中获取文件名( 不包含扩展名 )</summary>
        /// <param name="filePath">文件的绝对路径</param>
        ...
        /// <summary>从文件的绝对路径中获取扩展名</summary>
        /// <param name="filePath">文件的绝对路径</param>
        ...
        #region 清空指定目录
        /// <summary>清空指定目录下所有文件及子目录,但该目录依然保存.</summary>
        /// <param name="directoryPath">指定目录的绝对路径</param>
